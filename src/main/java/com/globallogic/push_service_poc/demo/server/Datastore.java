	...
	private static final List<String> regIds = new ArrayList<String>() {
		{
            ...
            // nexus one emulator
            add("APA91bHUUQpDH1bdkB7JdXF9aN3inrUrFOhgbLRoicKfvkceB4Vp5px6-TWHi2YUwaFJGXxLghncRdwJ8zBY8dLAAcBwaBQqNn4kP8fSZXAb2q0EAhXa8ClkSJcaOI8q4hmLsuXrL0R4-nBClDnPh2svZu3nQhUw3A");
			//nexus emulator
